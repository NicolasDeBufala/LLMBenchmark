...
from src.transformation.functions.ExtractPDFContent import convert_pdf_to_str_AzureDocumentIntelligence

class AzureDocumentIntelligenceOperation(TransformationOperation):
    """
    This class is used to perform OCR on PDFs using Azure Document Intelligence.
    """
    ...
    def run(self, inputData: PDFFile) -> TextContent:
        ...
        return convert_pdf_to_str_AzureDocumentIntelligence(inputData)
