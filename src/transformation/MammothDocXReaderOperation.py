...
from src.transformation.functions.ExtractDocXContent import convert_docx_to_str_mammoth

class MammothDocXReaderOperation(TransformationOperation):
    """
    This class is used to extract text from PDF files using Mammoth.
    """
    ...
    def run(self, inputData: DocXFile) -> TextContent:
        ...
        return convert_docx_to_str_mammoth(inputData)
