...
from src.transformation.functions.ExtractPDFContent import convert_pdf_to_str_pymupdf

class PyMuPDFReaderOperation(TransformationOperation):
    """
    This class is used to extract text from PDF files using PyMuPDF.
    """
    ...
    def run(self, inputData: PDFFile) -> TextContent:
        ...
        return convert_pdf_to_str_pymupdf(inputData)
