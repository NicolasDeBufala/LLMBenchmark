...
from src.transformation.functions.ExtractPDFContent import convert_pdf_to_str_pypdf

class PDFReaderOperation(TransformationOperation):
    """
    This class is used to extract text from PDF files using PyPDF.
    """
    ...
    def run(self, inputData: PDFFile) -> TextContent:
        ...
        return convert_pdf_to_str_pypdf(inputData)
