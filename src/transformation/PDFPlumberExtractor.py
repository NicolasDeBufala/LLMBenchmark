...
from src.transformation.functions.ExtractPDFContent import convert_pdf_to_str_pdfplumber

class PDFPlumberOperation(TransformationOperation):
    """
    This class is used to extract text from PDF files using PDFPlumber.
    """
    ...
    def run(self, inputData: PDFFile) -> TextContent:
        ...
        return convert_pdf_to_str_pdfplumber(inputData)
